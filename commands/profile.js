...
module.exports.run = async (bot, message, args) => {
 ...
 // .setDescription(`**${user}'s Profile**\n\nWallet: ${money} <:arzeus_coin:804370629654347788>\nBank: ${bank} <:arzeus_coin:804370629654347788>\n**VIP Roles**\n\nGiratina: ${giratina}\nPalkia: ${palkia}\nDialga: ${dialga}\n\n**Inventory**\n\nShoes: ${shoes}\nCars: ${car}\nHouses: ${house}\nT-Shirts: ${tshirt}\nSuits: ${designersuit}\n\n**PETS**\n\nHamsters: ${hamster}\nFishes: ${fish}\nCats: ${cat}\nDogs: ${dog}`)
  .setTitle(`**__${user.username} profile__**`)
 //   .addField('\u200b', '\u200b')
  
  .addField(`•────────────────────────────•\n> **1. Cash <a:paisaa:806007163671019600>**`, `<:dot:806038037238382613>Wallet: ${money} <:arzeus_coin:804370629654347788>\n<:dot:806038037238382613>Bank: ${bank} <:arzeus_coin:804370629654347788>\n<:dot:806038037238382613>NetWorth: ${networth} <:arzeus_coin:804370629654347788>\n•────────────────────────────•`)
  .addField(`> **2. VIP Roles <a:vip:806008105375760444>**`,`<:dot:806038037238382613>Giratina: ${giratina}\n<:dot:806038037238382613>Palkia: ${palkia}\n<:dot:806038037238382613>Dialga: ${dialga}\n•────────────────────────────•`)
  .addField(`> **3. Inventory 🏦**`,`<:dot:806038037238382613>Shoes: ${shoes}\n<:dot:806038037238382613>Cars: ${car}\n<:dot:806038037238382613>Houses: ${house}\n<:dot:806038037238382613>T-Shirts: ${tshirt}\n<:dot:806038037238382613>Suits: ${designersuit}\n•────────────────────────────•`)
  .addField(`> **4. Pets <a:DogRun:806020666989740033>**`,`<:dot:806038037238382613>Hamsters: ${hamster}\n<:dot:806038037238382613>Fishes: ${fish}\n<:dot:806038037238382613>Cats: ${cat}\n<:dot:806038037238382613>Dogs: ${dog}\n•────────────────────────────•`)
