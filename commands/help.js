...
module.exports.run = async (bot, message, args) => {
   // if(!message.content.startsWith('e!'))return;  
    ...
    //.addField("•────────────────────────────•","")
    .setDescription(`•────────────────────────────•\nMy Prefix is **Az!**\n•────────────────────────────•`)
    .addField("> <:pikasip:803606908103032852> **1. General Commands**","`Ping`,`info <user>`,`afk`,`back`,`avatar <user>`,`embed`,`uptime`,`rank`,`lb`")
    .addField("> <a:server:805812169521889340> **2. Server Commands**", "`staff`, `rules for staff`,`order`,`apply`,`vote`,`membercount`")//itna fast kaisai ;-;
    ...
    .addField("> <a:pandayay:807922510464417824> **5. Fun Commands**", "`hug`,`kill`,`math`,`flip`")
